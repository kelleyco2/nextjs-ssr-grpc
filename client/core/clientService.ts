...
export const ClientRequest = {
  ...
  create<I extends Exact<DeepPartial<ClientRequest>, I>>(
    base?: I
  ): ClientRequest {
...
export const ClientResponse = {
  ...
  create<I extends Exact<DeepPartial<ClientResponse>, I>>(
    base?: I
  ): ClientResponse {
    return ClientResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ClientResponse>, I>>(
    object: I
  ): ClientResponse {
    const message = createBaseClientResponse();
    message.id = object.id ?? 0;
...
export const ClientServiceRoutesService = {
  ...
  client: {
    ...
    requestSerialize: (value: ClientRequest) =>
      Buffer.from(ClientRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ClientRequest.decode(value),
    responseSerialize: (value: ClientResponse) =>
      Buffer.from(ClientResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ClientResponse.decode(value),
  },
} as const;

export interface ClientServiceRoutesServer
